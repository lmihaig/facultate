...
class Joc:
    ...
    def initializeaza(cls, display, NR_COLOANE=3, dim_celula=100):
        ...
        cls.x_img = pygame.transform.scale(
            ...
            (
                dim_celula,
                math.floor(dim_celula * cls.x_img.get_height() / cls.x_img.get_width()),
            ),
        )
                ...
                if self.matr[linie][coloana] == "x":
                    self.__class__.display.blit(
                        ...
                        (
                            ...
                            + (
                                ...
                                - self.__class__.x_img.get_height()
                            )
                            // 2,
                        ),
                    )
                    ...
                    self.__class__.display.blit(
                        ...
                        (
                            ...
                            + (
                                self.__class__.dim_celula
                                - self.__class__.zero_img.get_height()
                            )
                            // 2,
                        ),
                    )
    ...
    def linii_deschise(self, jucator):
        ...
        +self.linie_deschisa(
            [self.matr[0][0], self.matr[1][0], self.matr[2][0]], jucator
        )
        +self.linie_deschisa(
            [self.matr[0][1], self.matr[1][1], self.matr[2][1]], jucator
        )
        +self.linie_deschisa(
            [self.matr[0][2], self.matr[1][2], self.matr[2][2]], jucator
        )
        +self.linie_deschisa(
            [self.matr[0][0], self.matr[1][1], self.matr[2][2]], jucator
        )
        +self.linie_deschisa(
            [self.matr[0][2], self.matr[1][1], self.matr[2][0]], jucator
        )
