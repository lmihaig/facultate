...
void display(void)
{
   ...
   glBegin(GL_QUADS);
   glTexCoord2f(1.0, 1.0); glColor3f(1.0, 0.1, 0.1);  glVertex3f(-2.0, -1.0, 0.0);
   glTexCoord2f(1.0, 0.0); glColor3f(0.1, 1.0, 0.1);  glVertex3f(-2.0, 1.0, 0.0);
   glTexCoord2f(0.0, 0.0); glColor3f(1.0, 1.0, 0.1); glVertex3f(0.0, 1.0, 0.0);
   glTexCoord2f(0.0, 1.0); glColor3f(0.0, 0.1, 1.0); glVertex3f(0.0, -1.0, 0.0);
   glEnd();
   ...
   glTexCoord2f(1.0, 1.0); glVertex3f(4.0, 1.0, 0.0);
