...
void desen(void)
{
    ...
    glLightfv(GL_LIGHT1, GL_AMBIENT, alb);
    glLightfv(GL_LIGHT1, GL_DIFFUSE, negru);
    glLightfv(GL_LIGHT1, GL_SPECULAR, negru);
    ...
    glMaterialfv(GL_FRONT_AND_BACK, GL_EMISSION, magenta);
